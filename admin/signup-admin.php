    ...
    <div class="signup-form">
        <form action="" method="post">
            ...
            <div class="form-group text-right down">
                <label class="checkbox-inline">Already have an account? <a href="login-admin.php">Log In</a></label>
            </div>
        </form>
        <a href="login-admin.php"><button class="btn btn-danger">Back</button></a>
        </div>
        <?php
        if (isset($_POST['signup'])) {

            $query = "INSERT INTO tbl_admin (nm_admin,username,email,password) VALUE(' $_POST[nama]','$_POST[username]','$_POST[email]','$_POST[password]')";
            $exec = mysqli_query($db, $query);

            echo "<script type='text/javascript'>swal('Selamat', 'Anda Sudah Terdaftar', 'success');</script>";
            echo "<meta http-equiv='refresh' content='1;url=admin/login-admin.php'>";
        }
        ?>
</body>
